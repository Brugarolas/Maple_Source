...
public class KeyStrokes extends Module {
    ...
    public void renderKey(){
        ...
        this.drawCenteredStringWithShadow("W", centerX,y + (size / 2.0f),new Color(189, 189, 189, 255));
        this.drawCenteredStringWithShadow("A",x + (size / 2.0f) , centerY ,new Color(189, 189, 189, 255));
        this.drawCenteredStringWithShadow("S", centerX , centerY ,new Color(189, 189, 189, 255));
        this.drawCenteredStringWithShadow("D",(x + (size + margin) * 2) + (size / 2.0f) , centerY ,new Color(189, 189, 189, 255));
    }
    public void renderMouse(){
        ...
        this.drawCenteredStringWithShadow("LMB",x + 21, center,new Color(189, 189, 189, 255));
        this.drawCenteredStringWithShadow("RMB",x + 60 + margin, center,new Color(189, 189, 189, 255));

    }
    public void drawCenteredStringWithShadow(String text,float x,float y,Color color){
        this.mc.fontRendererObj.drawStringWithShadow(text,x - this.mc.fontRendererObj.getStringWidth(text) / 2.0f,y - this.mc.fontRendererObj.FONT_HEIGHT / 2.0f,color.getRGB());
    }
}
