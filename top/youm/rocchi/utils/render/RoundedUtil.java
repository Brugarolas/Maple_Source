...
public class RoundedUtil {
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("Rocchi/shader/roundRectOutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("Rocchi/shader/roundRectTextured.frag");
