...
//        animX = animator.animate((int) percentBar,animX,0.05f);
        ...
        RoundedUtil.drawRound(ClickGuiScreen.x + ClickGuiScreen.screenWidth - 150, (int) (ClickGuiScreen.y + 50 + y + 10),percentBar,2,2, Theme.titleColor);
        RenderUtil.drawCircle(ClickGuiScreen.x + ClickGuiScreen.screenWidth - 150 + percentBar, ClickGuiScreen.y + 50 + y + 11,5,Theme.titleColor);
