...
public class Notification {
    ...
    public void draw(float width ,float offsetY){
        ...
        RenderUtil.drawRect(this.animationX, this.animationY, this.notiWidth, notiHeight,  new Color(0, 0, 0, 150));
        RenderUtil.drawRect(this.animationX,this.animationY + this.notiHeight - 2,this.notiWidth, 2, HUD.getHUDThemeColor());
