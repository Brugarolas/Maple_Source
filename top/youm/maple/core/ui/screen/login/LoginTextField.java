...
public class LoginTextField extends Gui {
    ...
    /**
     * 
     * Has the current text being edited on the textbox.
     */
    private String text = "";
    private int maxStringLength = 350;
    ...
    public LoginTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                RenderUtil.drawRect(xPosition - 1,yPosition - 1 ,width + 2,height + 2,new Color(103, 80, 218));
                RenderUtil.drawRect(xPosition,yPosition,width,height,-1);
            }
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) FontLoaders.robotoR22.drawString(s1,  l,  i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int) FontLoaders.robotoR22.drawString(s.substring(j),  j1,  i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    RenderUtil.drawRect((float) k1, (float) i1 - 2,1f,13,new Color(100,100,100));
                }
            }

            if (k != j) {
                int l1 = l + FontLoaders.robotoR22.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 3 + FontLoaders.robotoR22.getHeight());
            }
        }
    }
