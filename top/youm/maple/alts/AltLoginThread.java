...
extends Thread {
    ...
    private Session createSession(String username, String password) {
        ...
        try {
            ...
            auth.logIn();
            return new Session(auth.getSelectedProfile().getName(), auth.getSelectedProfile().getId().toString(), auth.getAuthenticatedToken(), "legacy");
        }
    ...
    public void run() {
        if (this.password.equals("")) {
            this.mc.session = new Session(this.username, "", "", "legacy");
