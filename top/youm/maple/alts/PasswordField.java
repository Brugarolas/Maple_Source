...
public class PasswordField extends Gui
{
    ...
    private void drawCursorVertical(int par1, int par2, int par3, int par4) {
        ...
        worldRenderer.pos(par1, par4, 0.0).endVertex();
        worldRenderer.pos(par3, par4, 0.0).endVertex();
        worldRenderer.pos(par3, par2, 0.0).endVertex();
        worldRenderer.pos(par1, par2, 0.0).endVertex();
        tessellator.draw();
        GL11.glDisable(3058);
        GL11.glEnable(3553);
    }
